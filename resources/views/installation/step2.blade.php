                        ...
                        <div class="text-muted font-13">
                            <form method="POST" action="{{ route('purchase.code') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{env('BUYER_USERNAME')}}" placeholder="Enter Anything - OrderCode.Net" class="form-control"
                                           id="username"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{env('PURCHASE_CODE')}}" placeholder="Enter Anything - OrderCode.Net" class="form-control"
                                           id="purchase_key"
